...
- [x] 1.1 AI gate review report contract を定義する
  ...
  - _Requirements:_ 2.3, 4.1, 4.5
  - _Boundary:_ GateReviewContract
  - _Depends:_ none
...
- [x] 1.2 (P) AI gate fix report contract を定義する
  ...
  - _Requirements:_ 3.2, 4.2, 4.4
  - _Boundary:_ GateFixContract
  - _Depends:_ none
...
- [x] 1.3 AI-specific review instruction を作る
  ...
  - _Requirements:_ 2.1, 2.4, 2.5
  - _Boundary:_ GateReviewInstruction
  - _Depends:_ none
...
- [x] 1.4 (P) command-local AI fix instruction を作る
  ...
  - _Requirements:_ 3.1, 3.3, 5.2, 5.4
  - _Boundary:_ GateFixInstruction
  - _Depends:_ none
...
- [x] 2.1 internal callable AI gate workflow を追加する
  ...
  - _Requirements:_ 1.5, 2.2, 3.1, 3.3, 3.5, 4.5, 5.2, 5.5
  - _Boundary:_ GateWorkflowDefinition
  - _Depends:_ 1.1, 1.2, 1.3, 1.4
...
- [x] 2.2 plan と compose の caller route を AI gate 経由にする
  ...
  - _Requirements:_ 1.1, 1.2, 3.4, 5.1
  - _Boundary:_ CallerGateRoutes
  - _Depends:_ 2.1
...
- [x] 2.3 polish と deliver の caller route を AI gate 経由にする
  ...
  - _Requirements:_ 1.3, 1.4, 3.4, 5.1, 5.4
  - _Boundary:_ CallerGateRoutes
  - _Depends:_ 2.1
...
- [x] 3.1 runner の command report sync 対象に AI gate reports を含める
  ...
  - _Requirements:_ 4.3, 5.3, 6.3
  - _Boundary:_ GateEvidenceSync
  - _Depends:_ 2.1
...
- [x] 3.2 subworkflow report の current-run association を検証可能にする
  ...
  - _Boundary:_ GateEvidenceSync, GateReportAssertions
  - _Depends:_ 3.1
...
- [x] 4.1 gate placement と outcome route の static assertions を追加する
  ...
  - _Requirements:_ 6.1, 6.2, 6.4, 6.5
  - _Boundary:_ GateRouteAssertions
  - _Depends:_ 2.2, 2.3
...
- [x] 4.2 schema compatibility assertions を維持・拡張する
  ...
  - _Requirements:_ 5.6
  - _Boundary:_ GateSchemaAssertions
  - _Depends:_ 2.1, 4.1
...
- [x] 4.3 AI gate report freshness と optional fix rule の assertions を追加する
  ...
  - _Requirements:_ 3.2, 4.3, 4.4, 4.5, 6.3
  - _Boundary:_ GateReportAssertions
  - _Depends:_ 3.2
...
- [x] 5.1 foundation validation と smoke static validation を実行する
  ...
  - _Requirements:_ 5.1, 5.2, 5.3, 5.6, 6.1, 6.2, 6.3, 6.4, 6.5
  - _Boundary:_ GateRouteAssertions, GateReportAssertions, GateSchemaAssertions
  - _Depends:_ 4.1, 4.2, 4.3
...
- [x] 5.2 AI gate を含む command smoke path を確認する
  ...
  - _Requirements:_ 1.5, 2.2, 4.5, 6.3
  - _Boundary:_ GateWorkflowDefinition, GateEvidenceSync, GateReportAssertions
  - _Depends:_ 5.1
...
- [x] 5.3 scope boundary と residual risk を確認する
  ...
  - _Boundary:_ GateWorkflowDefinition, CallerGateRoutes, GateEvidenceSync
  - _Depends:_ 5.2
