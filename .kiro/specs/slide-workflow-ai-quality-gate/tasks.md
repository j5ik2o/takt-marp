...
- [x] 1.3 AI-specific review instruction を作る
  ...
  - _Boundary: GateReviewInstruction_
...
- [x] 2.1 internal callable AI gate workflow を追加する
  ...
  - _Requirements: 1.5, 2.2, 3.1, 3.3, 3.5, 4.5, 5.2, 5.5_
  - _Boundary: GateWorkflowDefinition_
...
- [x] 2.3 polish と deliver の caller route を AI gate 経由にする
  ...
  - _Requirements: 1.3, 1.4, 3.4, 5.1, 5.4_
  - _Boundary: CallerGateRoutes_
  - _Depends: 2.1_
...
- [x] 3.2 subworkflow report の current-run association を検証可能にする
  ...
  - _Boundary: GateEvidenceSync, GateReportAssertions_
  - _Depends: 3.1_
...
- [x] 4.1 gate placement と outcome route の static assertions を追加する
  ...
  - _Boundary: GateRouteAssertions_
  - _Depends: 2.2, 2.3_
...
- [x] 4.2 schema compatibility assertions を維持・拡張する
  ...
  - _Requirements: 5.6_
  - _Boundary: GateSchemaAssertions_
  - _Depends: 2.1, 4.1_
...
- [x] 4.3 AI gate report freshness と optional fix rule の assertions を追加する
  ...
  - _Requirements: 3.2, 4.3, 4.4, 4.5, 6.3_
  - _Boundary: GateReportAssertions_
  - _Depends: 3.2_
...
- [x] 5.1 foundation validation と smoke static validation を実行する
  ...
  - _Requirements: 5.1, 5.2, 5.3, 5.6, 6.1, 6.2, 6.3, 6.4, 6.5_
  - _Boundary: GateRouteAssertions, GateReportAssertions, GateSchemaAssertions_
...
- [x] 5.2 AI gate を含む command smoke path を確認する
  ...
  - _Requirements: 1.5, 2.2, 4.5, 6.3_
  - _Boundary: GateWorkflowDefinition, GateEvidenceSync, GateReportAssertions_
  - _Depends: 5.1_
...
- [x] 5.3 scope boundary と residual risk を確認する
  ...
  - _Boundary: GateWorkflowDefinition, CallerGateRoutes, GateEvidenceSync_
  - _Depends: 5.2_
