...
**やること:**
1. `brief.normalized.md`、`plan.md`、`slide-blueprint.md`、`design-system.md`、`sections/manifest.md`、`sections/*.md`、`SLIDES.md`、HTML visual、`images/*`、`review/compose-work.md` を読んでください。
...
- `design-system.md`、`sections/*`、`SLIDES.md`、HTML visual、`images/*` の修正で解消できる問題がある場合は `needs_fix` としてください。
