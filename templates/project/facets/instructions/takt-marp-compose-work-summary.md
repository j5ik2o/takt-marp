...
2. compose source artifacts が `plan.md`、`slide-blueprint.md` に記録された `contract_sha256` と Resolved Design Contract の `fingerprint.contract_sha256` に整合しているか確認してください。Design Brief fingerprint が記録されている場合は current Resolved Design Contract と一致しているかも記録してください。plan / blueprint が選定した Design System guidance、component prompt、starting point、card、sample、template、theme、font が compose source に反映されているかも記録してください。
