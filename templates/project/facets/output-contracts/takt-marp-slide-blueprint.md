...
- Blueprint Summary
  ...
  - Design Contract summary(source path、namespace、contract_sha256、Design Brief status/fingerprint)
...
- Design Contract Trace
  - `plan.md` と同じ contract_sha256 と Design Brief status/fingerprint を示す
...
- `plan.md` の Design Contract section と contract_sha256、Design Brief status/fingerprint または drift protection unavailable note、token constraints が矛盾してはなりません。
